...
class DataPageAlbum(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'Data_Page_album'


class DataPageSong(models.Model):
    file_type = models.CharField(max_length=10)
    song_title = models.CharField(max_length=250)
    album = models.ForeignKey(DataPageAlbum, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'Data_Page_song'
